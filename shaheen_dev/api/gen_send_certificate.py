...
def process_certificate_and_send(docname):
    try:
        ...
        contact_number = frappe.db.get_value('Student Registration' ,student_details.student_name,'contact_number')
        ...
        new_file_doc = frappe.get_doc({
            ...
            'is_private': 0,
            'attached_to_doctype':'Student Complete Progress',
            'attached_to_name': docname,
            'attached_to_field':'attached_certificate',
        })
        try:
            new_file_doc.insert()
